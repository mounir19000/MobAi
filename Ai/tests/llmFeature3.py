...
def book_recommender(user, user_orders):
    ...
    wishlist_books = [book for book in dummy_books if book["bookid"] in user_wishlist]

    # Retrieve other recommended books
    other_books = [book for book in dummy_books if book["id"] in recommended_book_ids]
